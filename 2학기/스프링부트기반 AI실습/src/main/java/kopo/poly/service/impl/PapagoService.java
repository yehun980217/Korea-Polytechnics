...
public class PapagoService implements IPapagoService {
    ...
    public PapagoDTO translate(PapagoDTO pDTO) throws Exception {
        ...
        log.info("{}.translate Start!", this.getClass().getName());
        ...
        String postParams = "source=" + source + "&target=" + target + "&text=" + URLEncoder.encode(text, StandardCharsets.UTF_8);
        ...
        log.info("srcLangType : {} / tarLangType : {} / translatedText : {} ", srcLangType, tarLangType, translatedText);
        ...
        log.info("{}.translate End!", this.getClass().getName());
